...
| **Google Business Profile (Maps) ops** | **`docs/RESUMORA_GOOGLE_BUSINESS_PROFILE_PLAYBOOK.md`** + `config/resumora-google-business-profile-checklist.json` + `npm run resumora:gbp:confirm` (Neon audit after manual GBP work) |
