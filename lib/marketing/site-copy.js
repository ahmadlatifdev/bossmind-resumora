...
export const translations = {
  en: {
    ...
    footerAboutLuxury:
      "Resumora is an executive resume and career dossier studio delivering ATS-grade artefacts, bilingual EN/FR narratives, and concierge delivery for leaders operating across regulated and cross-border hiring corridors.",
  ...
  fr: {
    ...
    footerAboutLuxury:
      "Resumora est un studio CV et dossiers carrière pour cadres : livrables compatibles ATS, récits EN/FR et livraison concierge pour les leaders sur des viviers réglementés et transfrontaliers.",
    footerColReach: "Contact",
    footerEmail: "support@resumora.net",
