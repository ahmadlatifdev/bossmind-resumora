...
export const translations = {
  en: {
    ...
    pricingTrustSecureLine:
      "Stripe-secure checkout · TLS throughout · encrypted intake · your materials are never resold.",
    ...
    pricingEssentialAdvancedHighlight:
      "Essential Advanced — full interview studio: simulations, training videos, recruiter Q&A, and success playbooks.",
  ...
  fr: {
    ...
    pricingTrustSecureLine:
      "Paiement sécurisé Stripe · TLS de bout en bout · intake chiffré · vos supports ne sont jamais revendus.",
    pricingWorkflowTrustLine:
    ...
    pricingEssentialAdvancedHighlight:
      "Essential Advanced — studio entretien complet : simulations, vidéos, Q&R recruteur et playbooks de réussite.",
...
export const pricingPlans = [
  ...
  },
  {
    ...
    featured: false,
    badge: "interview_studio",
    features: {
      en: [
        "3 advanced recruiter-style interviews (behavioral, technical, situational) with hiring-manager flow",
        "3 professional interview-training videos — real examples, body language, recruiter expectations",
        "50–60 high-value Q&A: leadership, teamwork, problem-solving, salary, career goals",
        "20 advanced success tips: psychology, confidence, communication, résumé sync, follow-up",
        "Dedicated interview success playbook + concierge routing after checkout",
      ],
      fr: [
        "3 entretiens avancés style recruteur (comportemental, technique, situationnel) avec flux hiring manager",
        "3 vidéos pro — exemples réels, langage corporel, attentes recruteur",
        "50–60 Q&R à forte valeur : leadership, équipe, résolution, salaire, objectifs carrière",
        "20 conseils succès avancés : psychologie, confiance, communication, synchro CV, relance",
        "Playbook réussite entretien + routage concierge après paiement",
      ],
    },
  },
];
...
export const pricingComparisonRows = [
  ...
  {
    key: "simulations",
    label: { en: "Interview simulations", fr: "Simulations d'entretien" },
    basic: false,
    professional: false,
    elite: false,
    essential_advanced: "3",
  },
  {
    key: "videos",
    label: { en: "Training videos", fr: "Vidéos formation" },
    basic: false,
    professional: false,
    elite: false,
    essential_advanced: "3",
  ...
  {
    key: "qa",
    label: { en: "Recruiter Q&A bank", fr: "Banque Q&R recruteur" },
    basic: false,
    professional: false,
    elite: false,
    essential_advanced: "50–60",
  },
  {
    key: "tips",
    label: { en: "Success tips", fr: "Conseils succès" },
    basic: false,
    professional: false,
    elite: false,
    essential_advanced: "20",
  },
];
