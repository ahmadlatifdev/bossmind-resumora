...
export const translations = {
  en: {
    ...
    homeLead:
      "Executive career studio — ATS-safe dossiers, bilingual delivery, concierge pacing.",
    trustAuthorityLabel: "Studio credentials",
    trustAuthorityBadges: ["ATS-safe exports", "Stripe secure checkout", "EN / FR studio", "Confidential intake"],
    essentialAdvancedTagline: "Specialized upgrade lane",
  ...
  fr: {
    ...
    homeLead:
      "Studio carrière exécutif — dossiers ATS, livraison bilingue, cadence concierge.",
    trustAuthorityLabel: "Garanties studio",
    trustAuthorityBadges: ["Exports compatibles ATS", "Paiement Stripe sécurisé", "Studio EN / FR", "Réception confidentielle"],
    essentialAdvancedTagline: "Palier upgrade spécialisé",
