...
export function getWeeklyBundle(lang, date = new Date()) {
  ...
  const labels = lang === "fr"
    ? {
        ...
        secondaryCta: "Chat",
        pipelineEyebrow: "Automatisation YouTube · TikTok",
        pipelineTitle: "Shorts hebdomadaires officiels (60 s)",
        pipelineIntro:
          "Cadence automatisée BossMind — expertise CV, ATS, entretiens, direction et viviers mondiaux.",
        watchLabel: "Lecture conseillée",
        photoAltA: "Palette luxe Resumora",
        photoAltB: "Signature visuelle studio",
        photoAltC: "Édition studio hebdomadaire",
    ...
    : {
        ...
        secondaryCta: "Chat",
        pipelineEyebrow: "YouTube · TikTok automation",
        pipelineTitle: "Official weekly Shorts (60s)",
        pipelineIntro:
          "BossMind automated cadence — resume expertise, ATS, interviews, executive positioning, global hiring.",
        watchLabel: "Suggested watch",
        photoAltA: "Resumora luxury palette",
        photoAltB: "Studio signature visual",
        photoAltC: "Weekly studio edition",
  ...
  return {
    ...
    photos: [
      { alt: labels.photoAltA, href: SITE_URL },
      { alt: labels.photoAltB, href: `${SITE_URL}/capabilities` },
      { alt: labels.photoAltC, href: `${SITE_URL}/marketing` },
    ],
    video: {
